...
#define TINYG_FIRMWARE_BUILD            1.0 // fixes for "startup banner" (new connection)
//#define TINYG_FIRMWARE_BUILD            GIT_EXACT_VERSION           // extract build number from tag
//#define TINYG_FIRMWARE_BUILD_STRING     JungleTinyG2                 // extract extended build info from git

#define TINYG_FIRMWARE_VERSION		    1.0							// firmware major version
#define TINYG_CONFIG_VERSION		    1.0							// CV values started at 5 to provide backwards compatibility
#define TINYG_HARDWARE_PLATFORM		    HW_PLATFORM_G2_DUE		// hardware platform indicator (2 = Native Arduino Due)
...
#define HOMING_AXES 6           // number of axes that can be homed (assumes Zxyabc sequence)
