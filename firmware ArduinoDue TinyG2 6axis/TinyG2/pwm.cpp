...
#define PWM_MIN_FREQ (F_CPU/64/65536/20)	// min frequency with supported prescaling
 ...
 */
#define PWM1_CTRLA_CLKSEL	TC_CLKSEL_DIV64_gc	// starting clock select value
...
static const char fmt_p1frq[] PROGMEM = "[p1frq] pwm frequency%18.0f Hz\n";
static const char fmt_p1csl[] PROGMEM = "[p1csl] pwm cw speed lo%16.0f RPM\n";
static const char fmt_p1csh[] PROGMEM = "[p1csh] pwm cw speed hi%16.0f RPM\n";
static const char fmt_p1cpl[] PROGMEM = "[p1cpl] pwm cw phase lo%16.3f [0..1]\n";
static const char fmt_p1cph[] PROGMEM = "[p1cph] pwm cw phase hi%16.3f [0..1]\n";
...
static const char fmt_p1pof[] PROGMEM = "[p1pof] pwm phase off%18.3f [0..1]\n";
